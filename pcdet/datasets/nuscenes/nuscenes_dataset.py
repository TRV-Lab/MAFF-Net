...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg_file', type=str, default="/home/tongji/weng/4DFusion/Dual-Radar/tools/cfgs/dataset_configs/nuscenes_mini_dataset.yaml", help='specify the config of dataset')
