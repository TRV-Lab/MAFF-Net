...
class BaseBEVBackbone(nn.Module):
    ...
    def forward(self, data_dict):
        ...
        if self.sensor_type == 'lidar':
            spatial_features = data_dict['lidar_spatial_features']
        elif self.sensor_type == 'radar':
            spatial_features = data_dict['radar_spatial_features']
        else:
            spatial_features = data_dict['spatial_features']
        # print("spatial_features 的形状为 ",spatial_features.shape[0])
        ...
        if self.sensor_type == 'lidar':
            data_dict['lidar_spatial_features_2d'] = x
        elif self.sensor_type == 'radar':
